...
<form class="form-horizontal col-sm-6 col-sm-offset-2" method="POST" action="{{route('review.update')}}" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="review" value="{{$data->comments}}" name="review" required>
        </div>
    ...
    <p>
        ...
        <a href="{{url('book/'.$data->book_id)}}" class="btn btn-primary col-sm-4 col-sm-offset-4" role="button">Kembali</a></p>
</form>
@endsection